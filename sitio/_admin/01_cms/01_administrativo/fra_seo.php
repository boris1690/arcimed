...
<tr>
	...
	<td class="titusecc" style="padding-bottom:7px;" background="../images/cms_titulo_fondo.png" width="100%"><img src="../images/cms_titulo_bullet.gif" width="18" height="3" border=0 alt="">SEO</td>
...
<tr>
	<td rowspan=3 valign=top width="100%"><iframe name="form" src="./frm_seo.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="no" width="100%" height="100%"></iframe></td>
	...
	<td valign=top>
		...
		<tr>
			<td width="100%%" bgcolor="#515151" align="center" class="titutabl">SEO</td>
		</tr>
		</table>
	</td>
</tr>
...
<tr>
	<td height="100%" valign=top><iframe name="ejec" src="./exe_seo.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="yes" width="350" height="392"></iframe></td>
</tr>
</table>
</center>
