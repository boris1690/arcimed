...
<? 
	...
	if ($varComando == "Ingresar")
	{
		...
		// ingreso el registro
		$recordset = funEjecutaQueryEdit ("insert into " . $aplPrefClie . "_dat_categoria values ($varCodiCate,'$varNombCate','$varEstaCate',$varCiudCate)");
	...
	if ($varComando == "Actualizar")
	{
		...
		$recordset = funEjecutaQueryEdit ("update " . $aplPrefClie . "_dat_categoria set NOM_CATEGORIA='$varNombCate', EST_CATEGORIA='$varEstaCate',COD_CIUDAD=$varCiudCate where COD_CATEGORIA=$varCodiCate");
