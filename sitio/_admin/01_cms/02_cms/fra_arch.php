...
<tr>
	...
	<td class="titusecc" style="padding-bottom:7px;" background="../images/cms_titulo_fondo.png" width="100%"><img src="../images/cms_titulo_bullet.gif" width="18" height="3" border=0 alt="">Archivos</td>
...
<tr>
	<td valign=top width="100%"><iframe name="form" src="./frm_arch.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="no" width="100%" height="100%"></iframe></td>
	<td><img src="./../images/blank.gif" width=10 height=10></td>
	<td valign=top>
		<table cellpadding="0" cellspacing="0" border="0">		
		<tr>
			<td><iframe name="busc" src="./frm_buscarch.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="no" width="100%" height="50"></iframe></td>
		</tr>
		...
		<tr>
			<td>
				...
				<tr>
					<td  align="center" bgcolor="#515151" class="titutabl"><b>Archivos</b></td>
				</tr>
				</table>
			</td>
		</tr>
		<tr><td><img src="./../images/blank.gif" width=10 height=2></td></tr>
		<tr>
			<td height="100%" valign=top><iframe name="ejec" src="./exe_arch.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="yes" width="350" height="342"></iframe></td>
		</tr>
		</table>
	</td>
</tr>
