...
<tr>
	...
	<td class="titusecc" style="padding-bottom:7px;" background="../images/cms_titulo_fondo.png" width="100%"><img src="../images/cms_titulo_bullet.gif" width="18" height="3" border=0 alt="">Categorias</td>
...
<tr>
	<td valign=top width="100%"><iframe name="form" src="./frm_cate.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="no" width="100%" height="100%"></iframe></td>
	...
	<td valign=top>
		...
		<tr>
			<td>
				...
				<tr>
					<td  align="center" bgcolor="#515151" class="titutabl"><b>Categorias</b></td>
				</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td height="100%" valign=top><iframe name="ejec" src="./exe_cate.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="yes" width="350" height="392"></iframe></td>
		</tr>
		</table>
	</td>
</tr>
