...
<tr>
	...
	<td class="titusecc" style="padding-bottom:7px;" background="../images/cms_titulo_fondo.png" width="100%"><img src="../images/cms_titulo_bullet.gif" width="18" height="3" border=0 alt="">Logs</td>
...
<tr>
	<td valign=top width="100%"><iframe name="form" src="./frm_conslogs.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="no" width="100%" height="130"></iframe></td>
</tr>
<tr>
	<td height="100%" valign=top><iframe name="ejec" src="./exe_conslogs.php" frameborder="0" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" scrolling="yes" width="100%" height="445"></iframe></td>
</tr>
</table>
